...
@Component({
  selector: 'app-machinery-maintenance',
  templateUrl: './machinery-maintenance.component.html',
  styleUrls: ['./machinery-maintenance.component.scss']
})
export class MachineryMaintenanceComponent implements OnInit {
